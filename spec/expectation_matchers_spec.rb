describe 'Expectation Matchers' do
  ...
  describe 'equivalnce matchers' do
    ...
    it 'will match value equality with #eql' do
      ...
      c = 17
      d = 17.0
      expect(c).to_not eql(d)    # not the same, close doesn't count
    end

    it 'will match value equality with #equal' do
      a = '2 cats'
      b = '2 cats'
      expect(a).not_to equal(b)       # same value but a different object
  ...
  describe 'truthiness matchers' do
    ...
    it "will match truthy/falsey" do
      ...
      expect(nil).to be_falsey      # but 0 is still not falsey enough
  ...
  describe 'numeric comparison matchers' do
    ...
    it 'will match ranges' do
      expect(10).to be_between(5,10).inclusive
      expect(10).not_to be_between(5,10).exclusive
      expect(10).to be_within(11).of(11)
  ...
  describe 'collection matchers' do
    ...
    it 'will match hashes' do
      ...
      expect(hash).not_to include({ 'a': 2, 'c': 2})
    end

  end

  describe 'other usefull matchers' do
  ...
  describe 'observation matchers' do
    ...
    it 'will match errors when raised' do
